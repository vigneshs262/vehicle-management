...
export default function AddVehicles() {
    ...
    return (
        ...
        <div className="text-white display-5 font"><strong>Vinfo</strong></div> 
          ...
          <Nav className="">
          <Nav.Link href="/garage" onClick={navtogarage} style={{fontSize:"1.5rem"}} ><strong className="text-white"><UndoIcon/>Back</strong></Nav.Link>
      ...
      <div>
        ...
        <form>
          ...
          <Button className="m-3" style={{backgroundColor:"#344292ce"}} type="submit" onClick={navtodetails}><AddCircleOutlineIcon/>
              Add
            </Button>
                </Col>
            </Row>

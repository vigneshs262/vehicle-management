...
export default function VehicleDetails() {
    ...
    return (
      ...
      <Card.Img variant="top" src="456.jpg" />
      <Card.Body>
        <Card.Title>Upload Documents</Card.Title>
        <Button style={{backgroundColor:"#344292ce"}} onClick={navtodocuments}>Enter</Button>
      </Card.Body>
    </Card>
    </div>
    <div className="m-3">
    <Card style={{ width: '18rem' }}>
      <Card.Img variant="top" src="123.jpg" />
      <Card.Body>
        <Card.Title>Document Store</Card.Title>
        <Button style={{backgroundColor:"#344292ce"}} onClick={navtodocinfo}>Enter</Button>
      </Card.Body>
    </Card>
    </div>
    </div>

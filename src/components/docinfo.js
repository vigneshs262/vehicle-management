...
export default function DocInfo() {
    ...
    return (
      ...
      <Container>
      <p className="display-5 m-3"><strong>Documents_Store</strong></p><br>
        </br>
        <Row>
            <Col lg={6}>
                <div className="doc">
      ...
      <Card.Img variant="top" src="bik.jpg" />
      <Card.Body>
        <Card.Title>TN XX SV XXXX</Card.Title>
        <Button style={{backgroundColor:"#344292ce"}} onClick={navtodocimages}>Enter</Button>
      </Card.Body>
    </Card>
    </div>
    <div className="m-3">
    <Card style={{ width: '18rem' }}>
      <Card.Img variant="top" src="carrrss.jpg" />
      <Card.Body>

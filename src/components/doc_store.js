...
export default function Doc_Store() {
    ...
    return (
        ...
        <div className="text-white display-5 font"><strong>Vinfo</strong></div> 
          ...
          <Nav className="">
          <Nav.Link href="/documents" onClick={navtodocments} style={{fontSize:"1.5rem"}} ><strong className="text-white"><UndoIcon/>Back</strong></Nav.Link>
      ...
      <p className="display-5 m-3"><strong>Document_Storage</strong></p><br>
        </br>
      <Container>
        <Row>
            <Col lg={6}>
      ...
      <Card.Body>
        ...
        <Button style={{backgroundColor:"#344292ce"}} onClick={navtodoc}>Enter</Button>
      </Card.Body>
    </Card>
    </div>
    <div className="m-3">
